var controladorCartoes = (function () {
    ...
    function criaCartao(conteudo, cor) {
        ...
        $('<div>').addClass('cartao').addClass(tipoCartao).append(opcoesDoCartao).append(conteudoNovoCartao).css('background-color', cor).attr('id', 'cartao' + contador).change(function (evento) {
            var cartao = $(this);
